...
- `results/runs/original_train/<run_name_or_auto_name>/`

Key files:

- `results/runs/original_train/<run_name_or_auto_name>/checkpoint/best_*.pth`: best checkpoint by validation loss
- `results/runs/original_train/<run_name_or_auto_name>/checkpoint/classifier_*.pth`: final checkpoint
- `results/runs/original_train/<run_name_or_auto_name>/tensorboard/events.out.*`: TensorBoard events
- `results/runs/original_train/<run_name_or_auto_name>/tensorboard/*.txt`: plain-text training log
- `results/runs/original_train/<run_name_or_auto_name>/run_summary.md`: markdown summary for alignment with NAS retrain reports
