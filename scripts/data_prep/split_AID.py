# -*- coding: utf-8 -*-
"""
将 AID 数据集按 5:1:4 分层随机划分到
- ASE-JSCC/data/AID-train
- ASE-JSCC/data/AID-valid
- ASE-JSCC/data/AID-test
...
SRC_DIR   =  REPO_ROOT / "AID"           # 官方结构的源目录
DST_TRAIN =   REPO_ROOT / "AID-train"    # 训练集输出
DST_VALID =   REPO_ROOT / "AID-valid"    # 验证集输出
DST_TEST  =   REPO_ROOT / "AID-test"     # 测试集输出
